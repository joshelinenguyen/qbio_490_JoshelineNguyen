...
```{r setup Exercise 2.3}
    ...
    knitr::opts_knit$set(root.dir = normalizePath("/GitHub/qbio490/qbio_490_JoshelineNguyen")) 
```
...
## add code here!
#string
name<-"josheline nguyen"
#int
age<-20
#string
birthday<-"09/03/2004"
#string vector
three_fav_colors<-c("Green", "Blue", "Orange")
name
age
birthday
three_fav_colors
...
if (random_int == random_int_2) {
  print("Fail!")
} else if (random_int_2 > random_int) {
  print("Success!")
} else {
  print("Fail!")
}
