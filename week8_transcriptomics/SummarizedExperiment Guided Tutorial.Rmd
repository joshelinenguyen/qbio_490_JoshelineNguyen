...
```{r setup}
    knitr::opts_knit$set(root.dir = normalizePath("/GitHub/qbio490/qbio_490_joshelinenguyen/analysis_data")) 
```
...
rna_clincal <- rna_clinical[,column_mask]
...
```{r Exercise 2.5}
write.csv(rna_clinical, '/home1/joshelin/490_cluster/analysis_data/BRCA_rna_clinical.csv')
...
write.csv(rna_genes, '/home1/joshelin/490_cluster/analysis_data/BRCA_rna_genes.csv')
rna_genes <- read.csv('/home1/joshelin/490_cluster/analysis_data/BRCA_rna_genes.csv')
```
...
write.csv(rna_counts, '/home1/joshelin/490_cluster/analysis_data/BRCA_rna_counts.csv')

rna_counts <- read.csv ('/home1/joshelin/490_cluster/analysis_data/BRCA_rna_counts.csv')
```
